...
assert.match(widget, /LOCAL_DEV_ORIGINS/);
assert.match(widget, /http:\/\/localhost:8788/);
assert.match(widget, /http:\/\/127\.0\.0\.1:8788/);
assert.match(widget, /VITE_GEMINI_ALLOW_LOCAL_DEV === 'true'/);
assert.match(widget, /isAllowedOrigin\(window\.location\.origin\)/);
assert.match(widget, /\/customer-support/);
